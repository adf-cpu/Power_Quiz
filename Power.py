...
def save_results(username, total_attempted, correct_answers, wrong_answers, total_score, time_taken, details):   
    try:
        df = pd.read_excel("quiz_results_power.xlsx")
    ...
    df.to_excel("quiz_results_power.xlsx", index=False)
...
if not st.session_state.logged_in:
    ...
    st.sidebar.markdown(f"## Welcome **{st.session_state.username}** For The Quiz Of Power ")
    ...
    # Quiz Page
    st.header(f"Welcome {st.session_state.username} For The Quiz Of Power")
